...
<%
    ...
    CallableStatement cstmt=connection.prepareCall("{call check_admin(?)}");
    ...
    if(rs.next())
    {
        ...
        {
            application.setAttribute("username",id);
            out.print("<script>alert('管理员登录成功!');window.location.href='adminUse.jsp'</script>");
        }
        else
        {
