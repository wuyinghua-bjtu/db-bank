			...
			<div class="row">
				<div class="col-md-12">
					...
					<form action="checkRegister.jsp" method = "POST">
						...
						<div class="row form-group">
							<div class="col-md-12">
								<label  for="id">电话号码</label>
								<input type="text" name="phone" class="form-control" placeholder="请输入常用手机号码">
							</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="password" name="password" class="form-control" placeholder="shur">
							</div>
						</div>
						...
						<div class="row form-group">
							<div class="col-md-12">
								...
								<input type="password" name="mspassword" class="form-control" placeholder="请重新输入">
							</div>
						</div>

						<div class="row form-group">
							<div class="col-md-12">
								<label  for="id">所属银行</label>
								<input type="text" name="bankBelongto" class="form-control" placeholder="请输入所属银行编号">
							</div>
