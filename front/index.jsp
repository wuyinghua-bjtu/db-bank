...
<html>
	...
	<header id="gtco-header" class="gtco-cover gtco-cover-md" role="banner" style="background-image: url(images/wyhsb.jpg)">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											...
											<form action="checkuser.jsp" method="POST">
												...
												<a href="changepassword.jsp" class="link" id="forgetpwd" target="_blank">修改密码</a>
												<a href="Adminlogin.jsp" class="link" id="admin" target="_blank">管理员登录入口</a>
											</form>	
										</div>
