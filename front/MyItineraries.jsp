                                ...
                                <div class="tab">
                                    <div class="tab-content">
                                        ...
                                        <%
                                            ...
                                            CallableStatement cstmt=connection.prepareCall("select * from account where idnumber = " + id);
                                            ...
                                            out.println("<p>余额:" + balance + "</p>");
                                            out.println("<p>所属银行:" + bbt + "</p>");

                                            %>
                                        <form action="service.jsp" method="POST">
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    <input type="submit" class="btn btn-primary btn-block" value="发起转账"  />
                                                </div>
                                            </div>
                                        </form>
                                        <form action="checkbalance.jsp" method="POST">
                                            <div class="row form-group">
                                                <div class="col-md-12">
                                                    <input type="submit" class="btn btn-primary btn-block" value="存款"  />
                                                </div>
                                            </div>
                                        </form>
                                    </div>
